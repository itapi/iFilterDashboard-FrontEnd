  ...
  const allMenuItems = [
    {
      ...
      path: '/apps',
      name: 'אפליקציות',
      allowedRoles: [ROLES.SUPER_ADMIN, ROLES.MANAGER], // Manager and above
      icon: (
    ...
    },
    {
      ...
      path: '/tickets',
      name: 'פניות לקוחות',
      allowedRoles: [ROLES.SUPER_ADMIN, ROLES.MANAGER, ROLES.COMMUNITY_MANAGER], // All roles
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className={`flex items-center space-x-3 p-3 rounded-xl bg-gray-50 ${
          ...
          {!isCollapsed && (
            <div className="flex-1">
              ...
              {userRole && (
                <div className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border mt-1 ${getRoleBadgeColor()}`}>
                  {getRoleDisplayName()}
                </div>
              )}
            </div>
